...
A beetle has following features:
Direction - direction of his position in the environment, east, north, west and south. Brain - decision function  (situation) -> action. The situation is combination of what the beetle sees and his inner states. 
  (if it is hungry, what is on the left,in the front and on the right)
