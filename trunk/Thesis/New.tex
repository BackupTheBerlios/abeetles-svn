...
In the field of Evolutionary computation simulators play an important part. Artificial life simulators can be ranked in many ways. In this work the organisation according to creature definition will be used.

In my work I've used the Genetic Programming technique which allows the evolution of parameter based organisms.
