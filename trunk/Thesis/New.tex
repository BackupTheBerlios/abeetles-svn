...
Being only one simulator in the row of other artificial life simulators, it is necessary to define clearly, which features of natural life will Abeetles examine. For this purpose will serve five existing simulators chosen to be an important example. Reasons for choice of each of them will be described later. Common attribute of all of them is that their binaries are freely accesible. Abeetles is also free software and is intended to examine original set of features of natural life only within free software. Features of selected simulators will be described and on their base will be chosen the set of features of the nature Abeetles will focus on and other attributes of the simulator.

The number of presented features is 31.

\section {Avida}
Avida is often presented example of a program based simulator. It studies evolution of programs. For definition targets of Abeetles is important Avida's implementation - two programs, gui and console version - serve to scientific purposes, can run very fast, but can ofer graphical output as well.

\begin{tabular}{|p{150pt}|p{220pt}|}
\hline
Agents&segments of code in simple language\\ \hline
Body& one cell in the grid of the environment\\ \hline
Motion&no\\ \hline
Behavior&semantics of the code\\ \hline
Features& code size, size of code of a child, stack and registers, gestation time\\ \hline
Life span&not restricted\\ \hline
Genes&string is itself a genome\\ \hline
Relation between genotype and phenotype&equal\\ \hline
Phenotypic space&any string of code in the language\\ \hline
Learning&no\\ \hline
textbf{Reproduction}&\\ \hline
Mating&no\\ \hline
Number of parents&1\\ \hline
Number of offspring in one reproduction&1\\ \hline
Creation of genotype of child&Poisson-random mutation\\ \hline
Choice of possible partner&no\\ \hline
Conditions of copulation&no\\ \hline
Investment in offspring&no\\ \hline
&\\ \hline
Fitness function&\\ \hline
&\\ \hline
\textbf{Environment}&\\ \hline
Features&tasks, whose completion gives bonus to the string\\ \hline
Description&grid of cells of the shape of torus\\ \hline
Inhabitants& only agents\\ \hline
&\\ \hline
textbf{UI settings}&\\ \hline
Reproduction&mutation rate according to types of mutation ( 3 types)\\ \hline
life of individual&initial genomes of initial individuals\\ \hline
environment&resources and tasks of the environment\\ \hline
overviews&instruction viewer, string details, graphs of \\ \hline
&\\ \hline
Implementation features&\\ \hline
Distribution of computation&yes\\ \hline
Speed settings&view:textual/graphical\\ \hline
sources available&yes\\ \hline
accesibility of exe&yes\\ \hline
\end{tabular}
...
&Bitozoa\\
&Neural networks\\
Individual&Bitozoa - herbivora/carnivora\\
...
Life span&(?)\\
Genes&(?)\\
Relation between genotype and phenotype&direct\\
phenotypic space&angle of flagella connection to body, number of neurons, topology of neural network, distance sensitivity and angular sensitivity of eyes\\
mems, learning&no\\
Mating&\\
Number of parents&2 nebo 1\\
Number of offspring in one reproduction&1-n (2parents) nebo 1(1parent)\\
Creation of genotype of child&random number of genes from both parents + mutation\\
Choice of possible partner&any met bitozoa of the same species with high enough stamina\\
Conditions of copulation& meeting of two bitozoa with high enough stamina level and from the same species\\
Investment in offspring&30(*) stamina inherited - 2 parents, 50% - 1 parent\\
Fitness function&\\
Environment&\\
features&number of spots, where food grows\\
description&toroid\\
inhabitants&world consist of food growing on special spots, herbivores eating plants, and carnivores eating herbivores\\
UI settings&\\
mating&breed distance, breed level of stamina, inherited stamina\\
life of individual&asexual reproduction allowed, burned stamina per movement, per neuron, stamina at start, flagella angle, initial eye sensitivity, stamina gained from eaten herbivore, strength of carnivore, life cost per time step, stamina level for asexual reproduction, killing of bitozoa, number of neurons at start, eat distance, flagella efficiency, sight distance\\
environment&no. of bitozoa and food spots at start, adding or killing of bitozoa, time increment, viscosity, random numbers generator seed\\
overviews&graph of populations, energy flow and energy flow averaged, Save simulation description, Collect information to .txt file\\
Implementation features&\\
Distribution of computation&no\\
Speed settings&animation on-off, pause\\
sources available&only light version\\
accesibility of exe&allowed by author\\
\end{tabular}
