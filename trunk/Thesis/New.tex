...
%*************Evolutionary computation: if we choose evolution of biological life as the topic of our artificial life exploration.
One of these subfields is Evolutionary computation. It is a general term for several computational techniques which are based to some degree on the evolution of biological life in the natural world and simulated using computers. The most widely used form of evolutionary computation are Genetic Algorithms. Evolution techniques are mostly focused on evolution of motion, shape, visual art and music. 
...
In the field of Evolutionary computation simulators play an important part. Artificial life simulators can be ranked in many ways. First, cathegorisation according to the method of creature definition will be used.
\begin{itemize}
...
Another attitude to simulators can be taken according to phenomenon, that they try to simulate. \url{http://vlab.infotech.monash.edu.au/}
\begin{itemize}
  ...
  \item \textbf{Non-linear} - Non-linear systems are systems that cannot be mathematically described as the sum of their components. While certain assumptions can be made for linear systems, that often make the mathematical modelling of such systems easy, mathematical modelling of non-linear systems is often very difficult or impossible. As a result, non-linear systems are often studies through use of simulations.
...
Target of this thesis is to create a system, simulating life of parameter based organisms and focus on evolution of their features and behavior. The system should availe experiments with evolution of the organisms under different conditions. Furthemore, several experiments performed with the system are described and a few other proposed.
