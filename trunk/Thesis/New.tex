...
Initial number of beetles is 100, their features were chosen randomly with rule "step on flower". Costs of actions were set to 2 for a step, 2 for a turn, 3 for mating and 1 for waiting. 30,000 updates were made. Function of energy from flower is shown in figure \ref{img.four_caves_eff}. The EFF function restricts the age of beetle to approximately 100 years.
...
Initial features of beetles were random, histogram of run 1 at the beginning: \ref{img.four_caves_run1_hist0}. The Situation after 30,000 updates is in \ref{img.four_caves_run1_hist30000}.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{Resume of fulfilling of objectives and other known attitudes}
