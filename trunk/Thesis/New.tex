...
The border between two updates is method NextTime() of class CEnvironment. Among others, it counts statistics of the previous turn.
...
\begin{figure}
\begin{center}
  \includegraphics [scale=0.6]{AbeetlesGUI.eps}
