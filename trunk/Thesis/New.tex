...
Cathegory Environment includes:
...
Cathegory User Interface Settings  encompasses:UI settings(=attributes, in which can a user influence the artificial life run by the simulator. They are sorted in 3 cathegories)
Mating
Life of individual
Environment
...
Cathegory Implementation holds:
...
textbf{Agents}&Bitozoa - herbivora(eats plants) or carnivora(eats herbivora)\\ \hline
...
Inhabitants&food growing on special spots, herbivores and carnivores\\ \hline
...
Inhabitants&food bits, swimbots\\ \hline
\hline \textbf{UI settings}&\\ \hline
...
&\\ \hline
&\\ \hline
do uvodu:&"  A Primordial Life Server provides lists of available ecosystems you can connect with.   Ecosystems still connect peer to peer& the server just provides addresses of other ecosystems willing to let you connect with them. Advanced setting available !!"\\ \hline
\end{tabular}
