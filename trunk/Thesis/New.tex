...
%aspect of running of experiments
\begin{itemize}
...
\begin{itemize}
\item Speed: A slow run of the simulator helps to see what happens.
\item User Interface: A zoom can make possible to see the situation in details as well as overlook the whole environment.
\item Input: Possibility to start default interface with random beetles easily is necessary at the beginning of work with the simulator. Also to save and load the actual situation is of use.
\item Output: To save statistics can be performed in any turn.  
\end{itemize}

%A ted by mohl prijit Funkcni model: sluzby pro zaznam, udrzbu a vyuziti dat.
\section{Functionality of Abeetles}

Expectations on the simulator imply model of
