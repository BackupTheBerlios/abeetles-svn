...
The model of life in Abeetles is described in chapter Analysis. Now decomposition proceedes and data structures are designed.
The key data structures of Abeetles are beetles and an environment.
A beetle has following features:
Direction - direction of his position.
Brain - decision function  (situation) -> action. Situation is combination of what the beetle sees and his inner states. 
